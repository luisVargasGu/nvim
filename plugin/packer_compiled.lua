...
_G.packer_plugins = {
  ...
  ["sonarlint.nvim"] = {
    loaded = true,
    path = "/Users/luisvargas/.local/share/nvim/site/pack/packer/start/sonarlint.nvim",
  ...
  ["typescript.nvim"] = {
    loaded = true,
    path = "/Users/luisvargas/.local/share/nvim/site/pack/packer/start/typescript.nvim",
